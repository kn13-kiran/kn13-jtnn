...
def tensorize(tree_batch, vocab, assm=True):
    ...
    jtenc_holder,mess_dict = JunctionTreeEncoder.tensorize(tree_batch)
    jtenc_holder = jtenc_holder
    mpn_holder = MessagePassingNetwork.tensorize(smiles_batch)
    ...
    jtmpn_holder = JunctionTreeMessagePassingNetwork.tensorize(cands, mess_dict)
