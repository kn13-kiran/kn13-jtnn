...
from molecule_tree import MoleculeTree, MoleculeTreeNode
...
class JunctionTreeDecoder(nn.Module):
    ...
    def __init__(self, vocab, hidden_size, latent_size, embedding):
        super(JunctionTreeDecoder, self).__init__()
    ...
    def decode(self, x_tree_vecs, prob_decode):
        ...
        root = MoleculeTreeNode(self.vocab.get_smiles(root_wid))
        root.wid = root_wid
        root.idx = 0
        ...
        for step in xrange(MAX_DECODE_LEN):
            ...
            if not backtrack: #Forward: Predict next clique
                ...
                for wid in sort_wid[:5]:
                    ...
                    node_y = MoleculeTreeNode(self.vocab.get_smiles(wid))
                ...
                if next_wid is None:
                    ...
                    node_y = MoleculeTreeNode(self.vocab.get_smiles(next_wid))
                    node_y.wid = next_wid
