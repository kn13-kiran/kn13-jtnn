...
class JunctionTreeMessagePassingNetwork(nn.Module):

    def __init__(self, hidden_size, depth):
        super(JunctionTreeMessagePassingNetwork, self).__init__()
    ...
    def forward(self, fatoms, fbonds, agraph, bgraph, scope, tree_message): #tree_message[0] == vec(0)
        ...
        bonds_input = self.W_i(fbonds)
        graph_message = F.relu(bonds_input)
        ...
        for i in xrange(self.depth - 1):
            ...
            graph_message = F.relu(bonds_input + nei_message)
